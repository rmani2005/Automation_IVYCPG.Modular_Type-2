...
public class ToVerifyEDIT_SM_LL_TC_08 extends TestStoreManagementSuiteBase
{
	...
	public void test1(String NSM,String RSM,String SM,String TM,String ZM,String SE,String DIST,String code,String name,String national,String regional,String state,String territory,String zone,
			String subzone,String area,String location,String globalchannel,String channel,String subchannel,String retailertype,String firstName,String lastName,String addressType,String address1,String editingname)
	{
		count++;
		...
		try{
			...
			TestBase.getElement(driver, TestBase.OR.getProperty("data_seletion")).click();
			APP_LOGS.info("Clicked on the data in grid");
			
			TestBase.getElement(driver, TestBase.OR.getProperty("storeMaster_EDIT")).click();
			APP_LOGS.info("Clicked on EDIT label");
			
			driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
			WebElement name_Field=TestBase.getElement(driver, TestBase.OR.getProperty("name_Field"));
			name_Field.clear();
			name_Field.sendKeys(editingname);
			...
			Assert.assertEquals(actual2, "Retailer details updated successfully.");
...
/*	
	TestBase.getElement(driver, TestBase.OR.getProperty("deactivated_Label")).click();
	APP_LOGS.info("Clicked on the Deactivated label");
	
	driver.manage().timeouts().implicitlyWait(400, TimeUnit.SECONDS);
	
	TestBase.getElement(driver, TestBase.OR.getProperty("activate_Data_Selection")).click();
	APP_LOGS.info("Clicked on data in deactivated reatailers grid");
	
	TestBase.getElement(driver, TestBase.OR.getProperty("makingActivate_Label")).click();
	APP_LOGS.info("Clicked on Make activate label");
	...
	Assert.assertEquals(actual2, "Retailer Activated Successfully!");
	*/
