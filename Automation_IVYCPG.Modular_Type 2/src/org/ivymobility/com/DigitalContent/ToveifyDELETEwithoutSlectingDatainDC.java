...
public class ToveifyDELETEwithoutSlectingDatainDC extends TestDigitalContentSuitBase
{
	...
	public void test1()
	{
		...
		try{
			...
			WebElement delete=TestBase.getElement(driver, TestBase.OR.getProperty("DC_DCM_Delete_Label"));
