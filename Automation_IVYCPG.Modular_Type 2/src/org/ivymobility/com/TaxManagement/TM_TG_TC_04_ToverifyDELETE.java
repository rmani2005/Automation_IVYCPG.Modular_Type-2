...
public class TM_TG_TC_04_ToverifyDELETE extends TestTaxManagementSuiteBase
{
	...
	public void test1(String groupName,String taxRate)
	{
		...
		try{
			...
			WebElement startdate_Calendar=TestBase.getElement(driver, TestBase.OR.getProperty("StartDateValue_D"));
			...
			WebElement enddateValue = TestBase.getElement(driver, TestBase.OR.getProperty("EndDateValue_D"));
			...
			WebElement tax_Delete=TestBase.getElement(driver, TestBase.OR.getProperty("TaxGroup_DELETE"));
			if(tax_Delete != null)
			{
				tax_Delete.click();
			...
			Assert.assertEquals(actual1, "Tax group deleted successfully");
