...
public class PM_PG_TC_01_ToVerifyADDscreen extends TestPriceGroupsSuiteBase
{
	...
	public void test1()
	{
		...
		try{
			...
			TestBase.getElement(driver, TestBase.OR.getProperty("PG_ADD")).click();
			APP_LOGS.info("Clicked on ADD label");
			
			boolean code=TestBase.getElement(driver, TestBase.OR.getProperty("PG_code_text")).isDisplayed();
			if(code)
			{
			...
			boolean name=TestBase.getElement(driver, TestBase.OR.getProperty("PG_name_text")).isDisplayed();
			if(name)
			{
