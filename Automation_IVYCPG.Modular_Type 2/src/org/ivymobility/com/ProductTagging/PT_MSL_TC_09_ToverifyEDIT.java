...
public class PT_MSL_TC_09_ToverifyEDIT extends TestProductTaggingSuiteBase
{
	...
	public void test1(String code,String name,String group_code,String group_desc,String sku_code,String channel,String area_code,String name_EDIT)
	{
		count++;
		...
		try{
			...
			Assert.assertEquals("Must Sell Saved Successfully", actual);
			
			Thread.sleep(1000);
			
			driver.switchTo().frame(TestBase.getElement(driver, TestBase.OR.getProperty("frame")));
			
			WebElement msl_Search_Field=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_search"));

			if(msl_Search_Field.isDisplayed())
			{
				msl_Search_Field.sendKeys(code);
				APP_LOGS.info("MSL CODE field is available");
			}
			else
			{
				APP_LOGS.error("MSL CODE search field is not available");
			}
			
			Thread.sleep(1000);
			
			WebElement msl_Searched_data=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_data_select"));

			if(msl_Searched_data.isDisplayed())
			{
				msl_Searched_data.click();
			...
			WebElement msl_EDIT=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_EDIT"));

			if(msl_EDIT.isDisplayed())
			{
				msl_EDIT.click();
			...
			{
				APP_LOGS.error("EDIT label is not available");
			}
			
			driver.manage().timeouts().implicitlyWait(400, TimeUnit.SECONDS);
			
			WebElement name_Field_EDIT=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_NAME_Field"));
			if(name_Field_EDIT.isDisplayed())
			{
				name_Field_EDIT.clear();
				name_Field_EDIT.sendKeys(name_EDIT);
				APP_LOGS.info("Name field is available & Edited");
			}
			else
			{
				APP_LOGS.info("Name field is not available");
			...
			WebElement next_Button3=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_Next"));
			if(next_Button3.isDisplayed())
			{
				next_Button3.click();
				APP_LOGS.info("Clikced on Next");
			}
			...
			WebElement next_Button4=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_GP_Next"));
			if(next_Button4.isDisplayed())
			{
				next_Button3.click();
				APP_LOGS.info("Clikced on Next");
			}
			...
			WebElement finish_EDIT=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_FINISH"));
			if(finish_EDIT.isDisplayed())
			{
				finish_EDIT.click();
				APP_LOGS.info("Clikced on Finish button");
			}
			else
			{
				APP_LOGS.info("Finish button is not available");
			}
			...
			Assert.assertEquals("Must Sell Saved Successfully", actual1);
