...
public class PT_MSL_TC_10_ToverifyDELETE extends TestProductTaggingSuiteBase
{
	...
	public void test1(String code,String name,String group_code,String group_desc,String sku_code,String channel,String area_code)
	{
		...
		try{
			...
			WebElement msl_DELETE=TestBase.getElement(driver, TestBase.OR.getProperty("PDT_MSL_DELETE"));

			if(msl_DELETE.isDisplayed())
			{
				msl_DELETE.click();
			...
			Assert.assertEquals("Must Sell deleted successfully!", actual1);
